...
public class TokenRequestsAdapter extends RecyclerView.Adapter<TokenRequestsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            Resturent = view.findViewById(R.id.Resturent);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        int count = Integer.parseInt(request.getTcount()) + Integer.parseInt(request.getConsumedTokens());
        holder.TTokens.setText(String.valueOf(count));
        holder.Resturent.setText(request.getRestaurantDetails().getName() + " (" + request.getRestaurantDetails().getCity() + ")");
